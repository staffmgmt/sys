...
class BrowserContext:
	...
	def is_running(self) -> bool:
		"""Checks if the browser context session appears to be active."""
		# A simple check, can be made more robust if needed by checking context.is_closed() or similar.
		if self.session and self.session.context:
			return True # Consider adding: and not self.session.context.is_closed() if Playwright context has such a flag
		return False
